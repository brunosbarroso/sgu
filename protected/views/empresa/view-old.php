...
jQuery('body').on('click','#botao-exclui',function(){if(confirm('Tem certeza que deseja excluir este item?')) {jQuery.yii.submitForm(this,'/sgu/index.php?r=$controller_id/delete&id=$model->id',{});return false;} else return false;});
");
...
$this->widget('bootstrap.widgets.TbButtonGroup', array(
	...
	array(
            ...
            'icon'=>'icon-trash',
            'url'=>'#',
            'htmlOptions'=>array('id'=>'botao-exclui'),
            ),
    ),
));
