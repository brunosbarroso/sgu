 ...
 * @property EstruturaFisica $pai
 * @property EstruturaFisica[] $estruturaFisicas
...
class EstruturaFisica extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'pai' => array(self::BELONGS_TO, 'EstruturaFisica', 'pai_id'),
			'estruturaFisicas' => array(self::HAS_MANY, 'EstruturaFisica', 'pai_id'),
